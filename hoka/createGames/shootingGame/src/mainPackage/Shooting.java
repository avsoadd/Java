		...
		while (loop) {
			...
			case GAME:
				...
				if (Keyboard.isKeyPressed(KeyEvent.VK_LEFT) && playerX > 0)
					playerX -= 5;
				if (Keyboard.isKeyPressed(KeyEvent.VK_RIGHT) && playerX < 455)
					playerX += 5;
				if (Keyboard.isKeyPressed(KeyEvent.VK_UP) && playerY > 50)
					playerY -= 5;
				if (Keyboard.isKeyPressed(KeyEvent.VK_DOWN) && playerY < 430)
					playerY += 5;
